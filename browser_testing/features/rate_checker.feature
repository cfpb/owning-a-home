...
Scenario: The House price field shows $200,000 as placeholder
  Given I navigate to the "Rate Checker" page
  Then I should see $"200000" as the default House price

@smoke_testing @rc  
Scenario: The Down Payment amount field shows $20,000 as placeholder
  Given I navigate to the "Rate Checker" page
  Then I should see $"20000" as the default Down Payment amount
...
@smoke_testing @rc  
Scenario Outline: The loan amount displayed should be calculated as (House Price - Down Payment = Loan Amount)
  Given I navigate to the "Rate Checker" page
  ...
  Then I should see "<down_payment_percent>" displayed as Down Payment percentage
    And I should see "<loan_amount>" displayed as Loan Amount

Examples:
  | house_price   | down_payment_amount  | down_payment_percent   | loan_amount   	|
  | 100,000       | 20,000 		           | 20                     | $80,000 		    |
  | 250,000				| 42,500 		           | 17                     | $207,500 	  	  |
  | 780,000			  | 68,640 		           | 9                      | $711,360 		    |
  | 1,250,000		  | 187,500 		         | 15                     | $1,062,500      |
