...
def before_all(context):
    ...
    if browser == 'Phantom':
        ...
        desired_capabilities = {
            'name': os.getenv('SELENIUM_NAME', 'OAH browser tests ') + datetime.now().__str__(),
            ...
            'video-upload-on-pass': os.getenv('SELENIUM_VIDEO_UPLOAD_ON_PASS', True),
        ...
        sauce_config = {"username": os.getenv('SAUCE_USER'), "access-key": os.getenv("SAUCE_KEY")}
